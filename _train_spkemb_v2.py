...
AVG_STYLE_PATH = os.environ.get(
    "SPKEMB_V2_STYLE_PATH",
    "output_models/hanamaru_prompt_style.pt"
)
SCHEDULER_BASE_LR = float(os.environ.get("SPKEMB_V2_BASE_LR", "1e-4"))
SCHEDULER_WARMUP = int(os.environ.get("SPKEMB_V2_WARMUP", "3000"))
SCHEDULER_LR_MIN = float(os.environ.get("SPKEMB_V2_LR_MIN", "1e-6"))
