# YingMusic-SVC 微调实战 — 训练代码 + 四模型发布

> 🎤 将任意唱歌音频转换为花丸晴琉（hanamaru）音色
>
> RTX 5070 Ti Laptop 12GB · Win11 · Python 3.10 · CUDA 12.8 · PyTorch 2.11.0
...
| **V1 15000** (Seed-VC) | 15000 | 音色最像（偏刺耳） | 音色优先        |
